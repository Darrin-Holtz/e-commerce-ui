...
const CartPage = () => {
  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="flex gap-8 flex-col lg:flex-row items-center lg:gap-16">
        {steps.map((step) => (
          <div
          ...
          {activeStep === 1 ? (
            cartItems.map(item => (
              <div className="flex items-center justify-between" key={item.id}>
                ...
                <button title="Remove item" className="w-8 h-8 rounded-full bg-red-100 text-red-400 hover:bg-red-200 transition-all duration-300 flex items-center justify-center cursor-pointer">
